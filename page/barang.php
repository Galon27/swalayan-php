                ...
                <div class="col-sm-4">
                  <div class="card d-flex shadow-sm" id="card-bg">
                    ...
                    <div class="card-body pb-0">
                      ...
                      <div class="d-block justify-contect-between p-2">
                        <button type="button" class="btn btn-warning col-3 ms-5" id="text" data-bs-toggle="modal" data-bs-target="#edit<?php echo $row['id_barang'] ?>">
                        ...
                        <a href="admin.php?page=transaksi_barang&id_barang=<?php echo $row['id_barang'] ?>" class="btn btn-primary col-3 me-4" id="text"><i class="bi bi-cart-plus-fill"></i></a>
                      </div>
                    </div>
