                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="tanggal" <?php $Now = new DateTime('now', new DateTimeZone('Asia/Taipei')); ?> value="<?php echo $Now->format('Y-m-d H:i'); ?>" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                                ...
                                <select name="id_user" class="form-control">
                                    ...
                                    ?>
                                        <option value="<?php echo $data['id_user'] ?>">
                                            <?php echo $data['nama_user'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="./db_conn/transaksi.php?aksi=delete&id_transaksi=<?php echo $data['id_transaksi'] ?>" class="btn btn-danger">Hapus</a>
                        </td>
                    </tr>
