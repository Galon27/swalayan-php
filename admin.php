...
<body>
    ...
    <div id="main" class="layout-horizontal">
        <header class="mb-5">
                    ...
                    <div class="header-top-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow-lg" aria-labelledby="topbarUserDropdown">
                                ...
                                <li>
                                    <div class="theme-toggle d-flex gap-2  align-items-center mt-2 ms-4">
                                ...
                                <li>
                                    <a class="dropdown-item" href="db_conn/logout.php">Logout</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <ul class="menu">
                            ...
                            <li class="sidebar-item  has-sub">
                                ...
                                <ul class="submenu ">
                                    ...
                                    <li class="submenu-item ">
                                        <a href="admin.php?page=pelanggan">Pelanggan</a>
                                    </li>
                                    <li class="submenu-item ">
                                        <a href="admin.php?page=barang">Barang</a>
                                    </li>
                                </ul>
                            </li>
            ...
            <div id="main" class="animate__animated animate__fadeInRight">
                <?php
                if (isset($_GET['page'])) {
                    $page = $_GET['page'];
                    switch ($page) {
